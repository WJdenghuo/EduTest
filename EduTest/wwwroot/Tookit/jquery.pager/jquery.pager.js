...
(function ($) {
    $.fn.pager = function (options) {
        ...
        return this.each(function () {
            ...
            if (options.amount != undefined && options.amount != "") {
                $(this).empty().append(renderpager2(parseInt(options.pagenumber), parseInt(options.pagecount), options.amount, parseInt(options.endPoint), options.showNext, options.showEnd, options.thisPage, options.buttonClickCallback));
            }
            else {
    ...
    function renderpager2(pagenumber, pagecount, amount, endPoint, showNext, showEnd, thisPage, buttonClickCallback) {
        ...
        if (thisPage != "false") {
            var span = ""
            if (amount == "") {
                span = $("<span class='pageCount'>\u5171 <font color='#f37c2c'>" + pagecount + amount + "</font> \u9875 \u5f53\u524d\u7b2c <font color='#669900'>" + pagenumber + "</font> \u9875</span>");
            }
            else {
                span = $("<span class='pageCount'>\u5171 <font color='#f37c2c'>" + pagecount + "\u9875" + amount + "</font>  \u6761 \u5f53\u524d\u7b2c <font color='#669900'>" + pagenumber + "</font> \u9875</span>");
            }
            $pager.append(span);
        }
        return $pager;
    ...
    function renderpager(pagenumber, pagecount, endPoint, showNext, showEnd, thisPage, buttonClickCallback) {
        ...
        if (thisPage != "false") {
            ...
            span = $("<span class='pageCount'>\u5171 <font color='#f37c2c'>" + pagecount + "</font> \u9875 \u5f53\u524d\u7b2c <font color='#669900'>" + pagenumber + "</font> \u9875</span>");
