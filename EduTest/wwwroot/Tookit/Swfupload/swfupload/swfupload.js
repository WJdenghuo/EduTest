...
SWFUpload.prototype.initSettings = function () {
	...
	// Flash Settings
	this.ensureDefault("flash_url", "/Tookit/Swfupload/swfupload/swfupload.swf");
	this.ensureDefault("prevent_swf_caching", true);
	
	// Button Settings
	this.ensureDefault("button_image_url", "/Tookit/Swfupload/images/TestImageNoText_65x29.png");
	this.ensureDefault("button_width", 65);
	this.ensureDefault("button_height", 29);
	this.ensureDefault("button_text", "浏  览");
	this.ensureDefault("button_text_style", "color: #000000; font-size: 16pt;");
	this.ensureDefault("button_text_top_padding", 3);
	this.ensureDefault("button_text_left_padding", 12);
